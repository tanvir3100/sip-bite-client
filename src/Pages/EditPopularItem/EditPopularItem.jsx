...
const EditPopularItem = () => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            if (res.data.success) {
                ...
                const productRes = await axios.patch(`/popular/${_id}`, productItem);
    ...
    return (
        <div>
            <h1 className='text-5xl text-center'>Edit Popular Product</h1>
            <h3 className='text-sm text-center'>Edit your Popular Product</h3>
